...
# from number_extraction import check
...
try:
    ...
    if(max_degree_left < 0):
        ...
        print("alaram rings")
        playsound("C:/Users/gayat/final year  project/jj.mp3")
    ...
    print("-----------------------FINAL RESULTS:-----------------------")
    print("your video is unable to identify the RESULTS")
    print("choose better video to identify with perfect divider line")


shutil.rmtree('C:/Users/gayat/final year  project/sub_final')
